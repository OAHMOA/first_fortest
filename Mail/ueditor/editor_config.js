...
(function () {
    ...
    window.UEDITOR_HOME_URL = "http://localhost/mail/ueditor/";
    URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    //URL = "http://localhost/mail/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["source","undo","redo","link","preview","gmap","insertimage","scrawl","music","insertvideo","emotion","snapscreen","attachment","insertframe","date","time","blockquote","highlightcode","background","bold","italic","underline","strikethrough","forecolor","backcolor","justifyleft","justifycenter","justifyright","justifyjustify","formatmatch","autotypeset","customstyle","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","inserttable","deletetable"]]
    ...
    ,lang:'zh-cn'
        ...
        ,initialFrameWidth:773  //初始化编辑器宽度,默认1000
